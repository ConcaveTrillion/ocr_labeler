...
Usage examples::
    ...
    ocr-labeler-export /path/to/labeled-ocr /path/to/output

    # Include all pages (skip validation check)
    ocr-labeler-export /path/to/labeled-ocr /path/to/output --all-pages

    # Include pages that have ground truth (even if not word-validated)
    ocr-labeler-export /path/to/labeled-ocr /path/to/output --require-gt

    # Export only italic words
    ocr-labeler-export /path/to/labeled-ocr /path/to/output --style italics

    # Export only small-caps words
    ocr-labeler-export /path/to/labeled-ocr /path/to/output --style "small caps"

    # Export multivariate classification dataset
    ocr-labeler-export /path/to/labeled-ocr /path/to/output --classification

    # Detection only (no recognition crops)
    ocr-labeler-export /path/to/labeled-ocr /path/to/output --detection-only

    # Recognition only (no detection polygons)
    ocr-labeler-export /path/to/labeled-ocr /path/to/output --recognition-only
"""
