...
from ocr_labeler.models.project import ProjectVM


class TestProjectVM:
    def test_initialization(self):
        """Test ProjectVM initialization with default values."""
        vm = ProjectVM()
        assert vm.pages == []
    ...
    def test_initialization_with_values(self):
        """Test ProjectVM initialization with provided values."""
        image_paths = [Path("test1.png"), Path("test2.png")]
        ground_truth_map = {"test1.png": "Ground truth 1"}
        vm = ProjectVM(image_paths=image_paths, ground_truth_map=ground_truth_map)
    ...
    def test_ensure_page_no_loader(self):
        ...
        vm = ProjectVM(image_paths=[Path("test.png")], pages=[None], ground_truth_map={"test.png": "Mock GT"})
    ...
    def test_current_page(self):
        ...
        vm = ProjectVM(image_paths=[Path("test.png")], pages=[None])
    ...
    def test_prev_page(self):
        ...
        vm = ProjectVM(current_page_index=1)
        vm.prev_page()
        assert vm.current_page_index == 0
    ...
    def test_next_page(self):
        ...
        vm = ProjectVM(image_paths=[Path("1.png"), Path("2.png")], pages=[None, None])
        vm.next_page()
    ...
    def test_goto_page_index(self):
        ...
        vm = ProjectVM(image_paths=[Path("1.png"), Path("2.png"), Path("3.png")], pages=[None, None, None])
