...
from pd_ocr_labeler.operations.ocr.page_operations import PageLoadInfo, PageOperations
...
class TestPageOperations:
    ...
    def test_load_page_model_removes_stale_cache_files_when_json_lacks_cached_images(
        ...
        saved_json = {
            ...
            "provenance": {
                ...
                "saved_by": "Save Page",
                "source_lane": "labeled",
                "app": {"name": "pd_ocr_labeler", "version": "0.1.0"},
    ...
    def test_save_page_preserves_loaded_empty_models_without_rerun(
        ...
        v2_json = {
            "schema": {"name": "pd_ocr_labeler.user_page", "version": "2.0"},
            "provenance": {
                "saved_at": "2026-02-15T00:00:00Z",
                "saved_by": "Save Page",
                "source_lane": "labeled",
